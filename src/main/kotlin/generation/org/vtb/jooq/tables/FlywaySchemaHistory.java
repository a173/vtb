...
public class FlywaySchemaHistory extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, LocalDateTime> INSTALLED_ON = createField(DSL.name("installed_on"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.LOCALDATETIME)), this, "");
